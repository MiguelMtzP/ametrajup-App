...
export class RegistroComponent implements OnInit {
  ...
  enviaForm(){
    this._authService.registro(this.foto,this.user).subscribe(res=>{
      ...
      localStorage.setItem("pais",res.usuarioRegistrado.pais)
      localStorage.setItem("estado",res.usuarioRegistrado.estado)
      localStorage.setItem("ciudad",res.usuarioRegistrado.ciudad)
